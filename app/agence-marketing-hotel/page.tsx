...
const description =
  "Agence de marketing hôtelier Maroc. Publicité Google Ads et SEO pour augmenter vos réservations directes depuis votre site web ☎️ 0663 75 09 08";
const imageUrl =
  "https://maroc-1hp.pages.dev/images/agence-marketing-hotel/agence-marketing-hotel-maroc.png";
...
const faqData = [
  {
    question:
      "Pourquoi un hôtel ou un riad au Maroc a-t-il besoin d'une stratégie marketing digitale ?",
    answers: [
  ...
  {
    question:
      "Comment le storytelling peut valoriser un hôtel ou riad marocain ?",
    answers: [
  ...
  {
    question:
      "Quelle est l'importance des avis clients pour un hôtel au Maroc ?",
    answers: [
  ...
  {
    question:
      "Comment Hostino aide les hôtels de luxe à séduire une clientèle internationale ?",
    answers: [
