  ...
  return (
    <main>
      ...
      <HeroSection
        ...
        text="Création, <b>référencement et sponsoring </b> des fiches Google My Business Maroc."
        emailLabel={{
      ...
      <section className="lg:mt-[150px] mt-[80px]">
        <div className="container">
          ...
          <p className="paragraph">
            Créer une fiche Google My Business au Maroc peut sembler simple,
      ...
      <TextLeftImageRight
        ...
        paragraphs={[
          "En plus de nos services de création, de gestion et d’optimisation des fiches Google My Business au Maroc, nous mettons à la disposition de nos clients <b>divers outils efficaces</b> qui facilitent et incitent leurs propres clients à laisser des avis sur leur profil Google My Business (GMB):",
      ...
      <TextLeftImageRight
        ...
        paragraphs={[
          "Avoir une fiche Google My Business est essentiel au Maroc, mais son impact est bien plus fort lorsqu’elle est combinée à un <b>site web bien référencé</b>. En effet, si Maps attire les clients localement, la plupart <b>préfèrent visiter le site</b> pour comparer, réserver ou acheter.&nbsp;",
