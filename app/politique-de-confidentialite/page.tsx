...
const description =
  "La politique de confidentialité de l&#039;hébergement web Hostino a été conçue afin de protéger les informations de nos clients.";
const imageUrl =
            ...
            <div className="grid md:grid-cols-12 grid-cols-1  gap-8">
              ...
              <div className="lg:col-span-9 md:col-span-7 col-span-1 text-legal-documents">
                <div>
                  ...
                  <p>
                    Le client s’engage à mettre à jour ses informations
                    (notamment changement d’adresse, tél, etc.) directement sur
                    son compte client chez Hostino.
                  </p>
                  <h3>10. Loi applicable – Attribution de juridiction :</h3>
                  <p>
                    Le présent contrat est régi par la loi marocaine, tout
                    litige relatif à l’interprétation ou à l’exécution des
                    présentes sera de la compétence du Tribunal de Commerce ou
                    tout autre tribunal choisi par le client au Maroc.
                  </p>
                  <h3>
                  ...
                  <p>
                    2. Le Titulaire bénéficie d’un usage exclusif et personnel
                    du nom de domaine enregistré pendant sa période de validité,
                    conformément aux dispositions réglementaires en vigueur.
                  </p>
                  <p>
                    3. Au moment de l’enregistrement ou du renouvellement d’un
                    nom de domaine, tout Demandeur ou Titulaire est censé avoir
                    accepté la collecte, le stockage et le traitement des
                    données le concernant par l’ANRT, ainsi que la publication
                    des données « WHOIS ».
                  </p>
                  <p>
                    4. Le Titulaire est censé avoir accepté que certaines
                    données le concernant soient transmises par l’ANRT aux
                    autorités compétentes, ou à une personne tierce conformément
                  ...
                  <p>
                    6. Le Titulaire est représenté par une personne physique,
                    dite contact administratif, dûment mandatée à cet effet et
                  ...
                  <p>
                    ...
                    de la gestion du nom de domaine. En cas de différend entre
                  ...
                  <p>
                    11. A l’expiration d’un nom de domaine, le Prestataire peut
                    le résilier au cas où le Titulaire ne procède pas au
                    paiement des frais de renouvellement y afférent. A la fin de
                    la période de grâce de renouvellement, le nom de domaine est
                    supprimé par l’ANRT.
                  </p>
                  <p>
                  ...
                  <p>
                    14. Le Titulaire a le droit de transférer son nom de domaine
                    à une autre personne, sous réserve du respect des termes de
                    la décision de nommage et du présent contrat.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    l’expiration de son nom de domaine trente (30) jours avant
                    sa date d’échéance, et lui permettre de renouveler son nom
                    de domaine à tout moment, avant ou durant la période de
                    grâce de renouvellement.
                  </p>
                  <p>
                  ...
                  <p>
                    3. A la résiliation du nom de domaine, le Prestataire est
                    tenu d’en informer le Titulaire, en lui précisant la période
                    de grâce de résiliation durant laquelle il peut récupérer le
                    nom de domaine résilié à tout moment.
                  </p>
                  <p>
                    ...
                    sur ce site, toutes les modifications apportées par l’ANRT
                    aux dispositions réglementaires et aux procédures
                    d’enregistrement et de gestion des noms de domaine.
                  </p>
                  <p>
                    5. Le Prestataire est tenu de porter à la connaissance du
                    Titulaire toute information ou notification le concernant
                    dès sa réception de la part de l’ANRT.
                  </p>
                  <p>
                  ...
                  <p>
                    7. A tout moment, et à la demande du Titulaire, le
                    Prestataire est tenu de lui fournir gratuitement le(s)
                    code(s) d’autorisation d’un ou de plusieurs noms de domaine,
                    dans un délai d’un (1) jour ouvrable à la réception de
                    ladite demande.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    aucune donnée, personnelle ou autre, relative à un
                    Titulaire, à des fins autres que celles prévues par
                    l’enregistrement et la gestion des noms de domaine du
                    Titulaire et ce, conformément aux dispositions
                    réglementaires en vigueur.
                  </p>
                  <p>
                    L’utilisation de ces données doit se faire en conformité
                    avec la réglementation sur la protection des personnes
