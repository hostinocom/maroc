...
interface GooglePositionsProps  {
  url: string;
  country: string;
  countryFlag?: string;
  keywords: Keyword[];
...
const RankingCard: React.FC<GooglePositionsProps> = ({ url, country, keywords }) => {
  return (
...
export const Cases: React.FC<CasesProps> = ({ data }) => {
  return (
...
export default function GooglePositioning({rankingsData , title , subtitle} : {rankingsData:GooglePositionsProps[] , title:string , subtitle:string}) {
     ...
     <div className="container">
      <div className="max-w-7xl mx-auto">
        <div className='flex flex-col mb-[30px] gap-5 items-center text-center justify-center'>
            <h1 className="big-title" dangerouslySetInnerHTML={{__html : title}} />
