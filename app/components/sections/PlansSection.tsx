...
const PlanCard = ({ plan }: { plan: Plan }) => {
  return (
    <div
      ...
      } bg-white relative  lg:text-left text-center rounded-[10px] lg:w-full md:w-[70vw] w-full mx-auto mb-4 md:pt-[55px] md:px-[50px] md:pb-[50px] lg:pt-[50px] lg:pb-[40px] lg:px-[40px] pt-[45px] px-[25px] pb-[35px]  border border-[#fcfcfc]  h-full`}
    >
