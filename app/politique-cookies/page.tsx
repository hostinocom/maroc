            ...
            <div className="grid md:grid-cols-12 grid-cols-1  gap-8">
              ...
              <div className="border-1 max-h-max lg:col-span-3 md:col-span-5 col-span-1 rounded-[10px] py-[30px] px-[30px] border-gray-300">
                ...
                <ul className="space-y-3">
                  ...
                  <li style={{ textDecoration: "underline" }}>
                    <Link className="active" href="/politique-cookies">
                      Politique Cookies
                    </Link>
                  </li>
                  <li style={{ textDecoration: "underline" }}>
              ...
              <div className="lg:col-span-9 md:col-span-7 col-span-1 text-legal-documents">
                <div>
                  ...
                  <p>
                    ...
                    nombreuses ressources expliquant ce que sont les cookies et
                    à quoi ils servent.
                  </p>
                  <p>
                    De notre côté, nous allons vous expliquer comment les
                    cookies affectent les sites web de Hostino. Toutefois, si
                    vous souhaitez en savoir plus, vous pouvez consulter la
                    documentation publiée par la Commission Nationale de
                  ...
                  <p>
                    Il existe différents types de cookies qui peuvent être
                    classés selon les critères suivants : (i) selon l’entité qui
                    les gère, (ii) selon leur finalité, et (iii) selon la durée
                    pendant laquelle elles restent actives.
                  </p>
                  <p>
                    Selon l’entité qui les gère, les cookies peuvent être
                    internes (cookies propres), c’est-à-dire enregistrées sur le
                    terminal de l’utilisateur depuis Hostino, ou de tiers,
                    enregistrées depuis un domaine ou site web différent de
                    Hostino, comme par exemple Google, YouTube, etc., qui
                    traitent les données personnelles selon leur propre
                    politique de cookies et politique de confidentialité.
                  </p>
                  <p>
                    En fonction de leur finalité, elles peuvent être : (i) des
                    cookies strictement nécessaires ou techniques,
                    indispensables à la navigation de l’utilisateur (par
                    exemple, activer les fonctions et services, contrôler le
                    trafic, etc.) ; (ii) des cookies analytiques, qui permettent
                    le suivi et l’analyse du comportement des utilisateurs pour
                    mesurer l’activité du site web ; et (iii) des cookies de
                    préférences ou de personnalisation, permettant de mémoriser
                    des informations pour offrir à l’utilisateur une expérience
                    personnalisée.
                  </p>
                  <p>
                    Enfin, selon la durée de conservation, elles peuvent être :
                    de session, collectant et stockant des données uniquement
                    pendant la session utilisateur ; ou persistantes, où les
                    données restent stockées sur le terminal et peuvent être
                    consultées et traitées pendant une période définie par le
                    responsable du cookie, allant de quelques minutes à
                    plusieurs années.
                  </p>
                  ...
                  <p>
                    ...
                    web et ne peuvent pas être désactivés dans nos systèmes.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <br />
                    Ces cookies sont liés à la publicité affichée à
                    l’utilisateur et collectent des informations sur son
                    comportement de navigation afin d’afficher des annonces
                    pertinentes.
                  </p>
                  <p>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          Domaine : IAB TCF
                          <br />
                          Description : Stocker les préférences de
                          confidentialité
                          <br />
                          Propriétaire : IAB
                          <br />
                  ...
                  <p>
                    L’utilisateur peut – à tout moment – choisir les cookies
                    qu’il souhaite autoriser sur ce site web, également via les
                  ...
                  <p>
                    ...
                    peut exercer son droit de suppression ou de désactivation
                    des cookies.
                  </p>
                  <p>
                    Ni ce site web ni ses représentants légaux ne peuvent
                    garantir la bonne ou mauvaise gestion des cookies par les
                    navigateurs mentionnés.
                  </p>
                  <p>
                  ...
                  <p>
                    L’acceptation de la présente politique de cookies implique
                    que l’utilisateur a été informé de manière claire et
                    complète sur l’utilisation des dispositifs de stockage et de
                    récupération de données (cookies), et que Hostino dispose de
                    son consentement pour leur utilisation, conformément aux
                    dispositions applicables en matière de protection des
                    données au Maroc.
                  </p>
                  <p>
