          ...
          <div className="grid md:grid-cols-12 grid-cols-1  gap-8">
            ...
            <div className="border-1 max-h-max lg:col-span-3 md:col-span-5 col-span-1 rounded-[10px] py-[30px] px-[30px] border-gray-300">
              ...
              <ul className="space-y-3">
                ...
                <li style={{ textDecoration: "underline" }}>
                  <Link className="active" href="/abus">Politique anti-bus</Link>
                </li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-9 md:col-span-7 col-span-1 text-legal-documents">
              <div>
                <p style={{ marginBottom: "0px !important" }}>
                  ...
                  Par email à : info@hostino.com Par téléphone au : +212 (05) 31
                  03 11 86
                </p>
                <h3>Introduction</h3>
                <p>
                  ...
                  cette Politique anti-abus afin de protéger nos utilisateurs et
                  de garantir un environnement en ligne sûr et respectueux.
                  Cette politique s’applique à toutes les interactions sur notre
                  site web et nos services, y compris les commentaires, les
                  espaces de discussion, les messages privés et les publications
                  sur les réseaux sociaux associés à notre site.
                </p>
                ...
                <ul>
                  <li>
                    ...
                    répétitifs, à des fins commerciales ou autres, est interdit.
                  </li>
                  <li>
                    Harcèlement et intimidation : le harcèlement, l’intimidation
                    ou la menace d’autres utilisateurs, que ce soit par des
                    commentaires, des messages privés ou d’autres moyens, sont
                    interdits.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    identités, l’usurpation de l’identité d’autres utilisateurs
                    ou la tentative de tromper les autres utilisateurs par des
                    moyens frauduleux sont interdites.
                  </li>
                  <li>
                    Attaques informatiques : les tentatives de piratage,
                    d’intrusion ou de déni de service visant notre site web, nos
                    services ou les comptes d’autres utilisateurs sont
                    interdites.
                  </li>
                </ul>
                <h3>Signalement des abus</h3>
                <p>
                  Si vous rencontrez un contenu ou un comportement qui enfreint
                  cette Politique anti-abus, veuillez nous le signaler
                  immédiatement en nous contactant à l’adresse e-mail suivante :
                  info@hostino.com ou en nous appelant au +212 (05) 31 03 11 86.
                  Veuillez inclure autant d’informations que possible pour nous
                  aider à évaluer et à traiter le problème rapidement et
                  efficacement.
                </p>
                ...
                <p>
                  ...
                  prendront effet immédiatement après leur publication sur notre
                  site web.
                </p>
                ...
                <ul>
                  ...
                  <li>
                    Signaler tout comportement ou contenu suspect ou inapproprié
                    en utilisant les moyens mis à votre disposition.
                  </li>
                  <li>
                ...
                <p>
                  ...
                  enquêter et traiter les cas d’abus signalés. Cela peut inclure
                  la fourniture d’informations sur les utilisateurs concernés,
                  dans la mesure permise par notre Politique de confidentialité
                  et la législation applicable.
                </p>
                <h3>Recours en cas de litige</h3>
                <p>
                  Si vous estimez que vos droits ont été violés ou que vous avez
                  subi un préjudice en raison du non-respect de cette Politique
                  anti-abus par un autre utilisateur, nous vous encourageons à
                  explorer les voies de recours légales disponibles dans votre
                  juridiction. Nous sommes prêts à coopérer avec les autorités
                  compétentes et à fournir toute assistance nécessaire dans le
                ...
                <p>
                  ...
                  respectueux pour tous les utilisateurs de notre site web et de
                  nos services. Merci de votre coopération et de votre
                  engagement à respecter cette Politique anti-abus.
                </p>
                <h3>Conclusion</h3>
                <p>
                  Nous nous engageons à créer et à maintenir un environnement en
                  ligne sûr et respectueux pour tous nos utilisateurs.
                  <br />
                  <br />
                  En respectant cette Politique anti-abus, vous contribuez à cet
                  objectif et aidez à garantir que notre communauté reste un
                  espace accueillant et positif pour tous.
                </p>
