...
const faqData = [
  {
    question: "Comment fonctionne une campagne Google Ads pour les entreprises au Maroc ?",
    answers: [
  ...
  {
    question: "Combien de temps faut-il pour obtenir des résultats avec Google Ads ?",
    answers: [
  ...
  {
    question: "Pourquoi chaque entreprise au Maroc devrait-elle allouer un budget mensuel Google Ads ?",
    answers: [
  ...
  {
    question: "Est-ce que Google Ads est adapté aux petites et moyennes entreprises",
    answers: [
  ...
  {
    question: "J'ai essayé de gérer moi-même Google Ads, pourquoi ça n'a pas marché ?",
    answers: [
  ...
  {
    question: "Comment faire pour que mon restaurant italien sorte numéro un à Rabat ?",
    answers: [
